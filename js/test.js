function fillDOM(dataArray) { 
	...
	for (var i= 0; i < dataArray.length; i++) {
		...
		target.childNodes[i].appendChild(document.createElement("IMG"));
		target.childNodes[i].childNodes[0].setAttribute("src", dataArray[i].img);
		target.childNodes[i].appendChild(document.createElement("P"));
		target.childNodes[i].childNodes[1].setAttribute("class", "product-body");
		target.childNodes[i].childNodes[1].innerHTML = "Name: " + dataArray.name;
		target.childNodes[i].childNodes[1].innerHTML += "Details: " + dataArray.descripton;
		target.childNodes[i].childNodes[1].innerHTML += "$: " + dataArray.price;
		target.childNodes[i].childNodes[1].innerHTML += "name: " + dataArray.name;		
	 }
}
