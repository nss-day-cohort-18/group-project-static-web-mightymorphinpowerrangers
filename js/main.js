var productDetails = [];
var placeTheProduct = document.getElementById('???');
var productObj {
  dasBoot: { name: 'Das Boot',
  ...
  price: '$10,000',
  img: '<img src="../images/product-data/watery/das-boot.jpg" alt="haunted submarine">'
  },
  ...
  japaneseVillage: { name: 'Japanese Village',
